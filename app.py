...
def load_data(file_path):
    ...
    data["Branch"]=data["Branch"].replace("C", "DHA")
    return data
...
sales_by_product_line=filtered_data.groupby("Product line")["Total"].sum().sort_values().reset_index()
...
st.plotly_chart(fig_product_line)
